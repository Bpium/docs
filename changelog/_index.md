...
## v3.4.1 от 19 августа 2026

Версия API: 3.4.1\
Версия веб-приложения: 3.4.0\
Версия сервера процессов: 3.1.6

**Ключевые изменения:**

-  Добавлены вычисляемые поля двух типов: [проброс (Lookup)](./../bpium-setup/catalogs-setup/kopirovanie-svyazey) и [подсчет (Rollup)](./../rabota-v-bipiume/katalogi/list/podschet).

-  Добавлен встроенный [планировщик](./../bpium-setup/systemcatalogs/upravlenie/planirovschik).

-  Добавлен тип поля [«Веб - страница (Iframe)»](./../bpium-setup/catalogs-setup/edit/osnovnye/veb-stranica).

-  Добавлена возможность изоляции компаний черех схемы базы данных вместо отдельных баз данных (для мультидоменных систем). 

**Ключевые изменения в веб-приложении:**

-  Добавлена новая система персональных/командных настроек отображения представлений (сортировка, видимость полей, фильтры). [Подробнее](./../rabota-v-bipiume/katalogi/views).

-  Изменено меню каталогов - вложенное дерево разделов вместо плоского списка, избранные каталоги, поиск по меню.

**Ключевые изменения в сервере API:**

-  Оптимизирована история записей.

-  Обновлен механизм проверки состояния API (`/healthcheck`).

**Ключевые изменения в сервере процессов:**

-  Добавлен компонент интеграции с [мессенджером «Max»](./../bpium-setup/processes/components/kommunikacii/max-2).

-  Обновлена библиотека для работы с компонентами почты.

:::info 

**Скачать дистрибутив** архивом для [Windows](https://storage.yandexcloud.net/download.bpium.ru/builds/3.4.1/bpium-win-v3.4.1.zip) или [Linux](https://storage.yandexcloud.net/download.bpium.ru/builds/3.4.1/bpium-linux-v3.4.1.zip)

**Докер-образы** bpiumdocker/bpium:v3.4.1, bpiumdocker/bpm:v3.4.1, bpiumdocker/s3:v3.4.1.
