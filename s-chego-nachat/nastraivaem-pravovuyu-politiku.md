...
Теперь, когда у нас уже есть небольшая система, нам необходимо разграничить доступ к данным системы между сотрудниками. Права в Бипиум можно задать как для раздельных сотрудников в системе, так и по объединяющим сотрудников сущностям: роль, раздел, регион и т.д. Рассмотрим оба варианта ниже:&#x20;
...
### Правила на уровне Раздела и Каталога
...
<figure><img src="../.gitbook/assets/image (178).png" alt=""><figcaption><p>Настройка прав доступа к разделу</p></figcaption></figure>

1. Переходим в нужный раздел (Компания)
2. В левом нижнем углу нажимаем "Свойства раздела"
3. Нажимаем кнопку "Доступ к разделу"

Откроется окно с правами по умолчанию: Все сотрудники - Администрировать

<figure><img src="../.gitbook/assets/image (180).png" alt=""><figcaption><p>Настройка прав доступа к разделу</p></figcaption></figure>
...
* Правило по умолчанию для всех сотрудников удаляем. После этого нажимаем кнопку "Сохранить".

<figure><img src="../.gitbook/assets/image (182).png" alt=""><figcaption><p>Настройка прав доступа к разделу</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (181).png" alt=""><figcaption><p> Настройка прав доступа к каталогу</p></figcaption></figure>

Откроется окно с правами доступа с правилами, унаследованными от раздела.
...
Права для Раздела были настроены ранее, их менять нам не требуется. Настроим права для Каталога: Для Анны привилегия будет такая же: "Создавать записи"\
