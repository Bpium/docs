...
![](<../../.gitbook/assets/Просто дашборд и стрелка на отчеты.png> "Дашборд во вкладке отчеты")
...
![](<../../.gitbook/assets/Новый дашборд.png> "Создание нового дашборда")

![](<../../.gitbook/assets/создание дашборда.png> "Создание нового дашборда")
...
![](<../../.gitbook/assets/Добавить график.png> "Добавить график")



### Вкладка «Данные»

![](<../../.gitbook/assets/вкладка данные.png> "Вкладка «Данные» с обозначением полей")
...
[image:./nastraivaem-dashbord.png::Выпадающий список поля «Посчитать»:0,0,100,100:::1500px:850px:left]
...
![](./nastraivaem-dashbord-2.png "Выпадающий список поля «Функция»"){width=1500px height=850px}

#### **3\. «Разложить по» -- по чему группируем (ось X)**

Выберите поле, по которому данные будут разбиваться на группы.

![](<../../.gitbook/assets/разложить по.png> "Выпадающий список поля «Разложить по»")
...
![](./nastraivaem-dashbord-3.png "Выпадающий список поля «Разбить по»"){width=1500px height=850px}
...
![](../../.gitbook/assets/фильтр.png "Вкладка «Фильтр»")
...
![](../../.gitbook/assets/шестеренка.png "График с иконкой шестеренки при наведении")

![](<../../.gitbook/assets/форма редактирования графика.png> "Форма редактирования графика")
...
![](<../../.gitbook/assets/выбор экрана для размещения графиков.png>)
...
*  {% colwidth=[565] %}
   ...
   По убыванию (чтобы видеть самого крупного клиента первым)
...
*  {% colwidth=[565] %}
   ...
   По выбору (все записи или только доступные сотруднику)
...
![](<../../.gitbook/assets/готовый график.png> "Заполненный конструктор с примера выше")

Сохраните график -- он появится на дашборде.

![](<../../.gitbook/assets/готовый график2.png> "Готовый дашборд с созданным графиком")