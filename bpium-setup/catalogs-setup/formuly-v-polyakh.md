...
![](<../../.gitbook/assets/Выбор Способа ввода «Формула».png> "Выбор Способа ввода «Формула»")
...
![](<../../.gitbook/assets/Способ ввода «Формула».png> "Способ ввода «Формула»")

## Интерфейс редактора формул

Редактор помогает быстро и правильно создавать выражения.

![](<../../.gitbook/assets/Интерфейс редактора формул.png> "Интерфейс редактора формул")
...
*  Применяется к булевому значению (результату выражения).
...
![](<../../.gitbook/assets/Пример использования формул.png> "Пример использования формул")