...
<figure><img src="../../.gitbook/assets/Выбор Способа ввода «Формула».png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Способ ввода «Формула».png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Интерфейс редактора формул.png" alt=""><figcaption><p>Интерфейс редактора формул</p></figcaption></figure>

1. Название поля в котором используется формула
...
4. Область написания формулы: Основное поле для ввода выражения (например, {Количество} \* {Цена}).
5. Область подсказки: Динамическая справка по синтаксису выбранной функции.
...
<table><thead><tr><th width="200">Оператор</th><th width="162">Пример</th><th width="136">Результат</th><th>Описание</th></tr></thead><tbody><tr><td>+</td><td>1 + 2</td><td>3</td><td>Сложение чисел или конкатенация строк.</td></tr><tr><td>-</td><td>5 - 2</td><td>3</td><td>Вычитание.</td></tr><tr><td>*</td><td>3 * 5</td><td>15</td><td>Умножение.</td></tr><tr><td>/</td><td>10 / 2</td><td>5</td><td>Деление.</td></tr><tr><td>%</td><td>12 % 7</td><td>5</td><td>Остаток от деления.</td></tr><tr><td>^</td><td>12 ^ 2</td><td>144</td><td>Возведение в степень.</td></tr></tbody></table>

**Строковый оператор**

<table><thead><tr><th width="199">Оператор</th><th width="155">Пример</th><th width="143">Результат</th><th>Описание</th></tr></thead><tbody><tr><td>&#x26;</td><td>5 &#x26; "2"</td><td>"52"</td><td>Склеивание (конкатенация) строк.</td></tr></tbody></table>

**Логические операторы**

<table data-header-hidden data-full-width="false"><thead><tr><th width="112">Оператор</th><th width="150">Пример</th><th width="140">Возвращаемое значение</th><th>Поддерживаемые типы (сравнение)</th></tr></thead><tbody><tr><td>Оператор</td><td>Пример</td><td>Результат</td><td>Описание</td></tr><tr><td><strong>></strong></td><td><code>1 > 2</code></td><td><code>false</code></td><td>Прямое сравнение: Число, Строка, Дата, Булевый тип.<br>Для остальных типов: преобразуются в строку и сравниваются.</td></tr><tr><td><strong>&#x3C;</strong></td><td><code>1 &#x3C; 2</code></td><td><code>true</code></td><td>Прямое сравнение: Число, Строка, Дата, Булевый тип.<br>Для остальных типов: преобразуются в строку и сравниваются.</td></tr><tr><td><strong>>=</strong></td><td><code>1 >= 2</code></td><td><code>false</code></td><td>Прямое сравнение: Число, Строка, Дата, Булевый тип.<br>Для остальных типов: преобразуются в строку и сравниваются.</td></tr><tr><td><strong>&#x3C;=</strong></td><td><code>1 &#x3C;= 2</code></td><td><code>true</code></td><td>Прямое сравнение: Число, Строка, Дата, Булевый тип.<br>Для остальных типов: преобразуются в строку и сравниваются.</td></tr><tr><td><strong>==</strong></td><td><code>1 == 2</code></td><td><code>false</code></td><td>Прямое сравнение: Число, Строка, Дата, Булевый тип.<br>Для остальных типов: преобразуются в строку и сравниваются.</td></tr><tr><td><strong>!=</strong></td><td><code>1 != 2</code></td><td><code>true</code></td><td>Прямое сравнение: Число, Строка, Дата, Булевый тип.<br>Для остальных типов: преобразуются в строку и сравниваются.</td></tr><tr><td><strong>!</strong></td><td><code>!(1 > 2)</code></td><td><code>true</code></td><td>Применяется к: Булевому значению (чаще всего является результатом выражения).</td></tr><tr><td><strong>&#x26;&#x26;</strong></td><td><code>(1 > 2) &#x26;&#x26; (3 > 2)</code></td><td><code>false</code></td><td>Работает с: Булевыми значениями (результатами условий).</td></tr><tr><td><strong>||</strong></td><td><code>(1 > 2) || (3 > 2)</code></td><td><code>true</code></td><td>Работает с<strong>:</strong> Булевыми значениями (результатами условий).</td></tr></tbody></table>
...
| DATEADD(дата, количество, единица)                                          | Добавляет интервал к дате. Единицы: "d" (дни), "m" (месяцы), "y" (годы) и др.                                                                 | DATEADD({ДатаСтарта}, 7, "d")         |
| DATESUB(дата, интервал, единица)                                            | Вычитает интервал из даты. Единицы: "d" (дни), "m" (месяцы), "y" (годы) и др.                                                                 | DATESUB({Дата}, 7, "d")               |
...
| STARTOF(дата, единица), ENDOF(дата, единица)                                | Сдвиг к началу/концу периода (дня, месяца, года).                                                                                             | STARTOF({Дата}, "m")                  |
...
<figure><img src="../../.gitbook/assets/Пример использования формул.png" alt=""><figcaption><p>Пример использования формул</p></figcaption></figure>
