...
\
После выбора способа ввода «Проброс по связям» в нижней части настроек поля появляются дополнительные параметры.

\[Скриншот: Дополнительные поля при выборе «Проброс по связям»\]
...
*  {% colwidth=[529] %}
   ...
   Выберите «Проброс по связям» из выпадающего списка
