...
2. Создайте новое поле или откройте настройки существующего. Для формул подходят следующие типы полей:&#x20;
...
<figure><img src="../../../.gitbook/assets/image (1).png" alt=""><figcaption><p>Редактор формул. Элементы.</p></figcaption></figure>
