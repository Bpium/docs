...
<table data-header-hidden><thead><tr><th width="205"></th><th></th></tr></thead><tbody><tr><td>Способ</td><td>Описание</td></tr><tr><td><strong>Правовой вид</strong></td><td>Вместо всего каталога можно указать конкретный правовой вид. В поле подгрузятся только записи, принадлежащие этому виду.</td></tr><tr><td>Ф<strong>ильтр</strong></td><td>Динамический фильтр, который показывает записи, соответствующие заданным критериям. Условия настраиваются как связь с полем текущей анкеты.</td></tr></tbody></table>
