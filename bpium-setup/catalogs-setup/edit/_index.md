...
Панель с настройками позволяет настроить поле под свои нужды. Свойства бывают общие для всех полей (подробнее в [Свойства](https://docs.bpium.ru/bpium-setup/catalogs-setup/svoistva)) и индивидуальные для каждого поля (подробнее в статье каждого поля).
