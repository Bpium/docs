...
![](<./Выбор Способа ввода «Формула».png> "Выбор Способа ввода «Формула»")
...
![](<./Способ ввода «Формула».png> "Способ ввода «Формула»")

## Интерфейс редактора формул

Редактор помогает быстро и правильно создавать выражения.

![](<./Интерфейс редактора формул.png> "Интерфейс редактора формул")
...
| Оператор | Пример               | Возвращаемое значение | Поддерживаемые типы (сравнение)                                                                                 |
|----------|----------------------|-----------------------|-----------------------------------------------------------------------------------------------------------------|
| \>       | 1 > 2                | false                 | Прямое сравнение: Число, Строка, Дата, Булевый тип. Для остальных типов: преобразуются в строку и сравниваются. |
| \<       | 1 \< 2               | true                  | Прямое сравнение: Число, Строка, Дата, Булевый тип. Для остальных типов: преобразуются в строку и сравниваются. |
| \>=      | 1 >= 2               | false                 | Прямое сравнение: Число, Строка, Дата, Булевый тип. Для остальных типов: преобразуются в строку и сравниваются. |
| \<=      | 1 \<= 2              | true                  | Прямое сравнение: Число, Строка, Дата, Булевый тип. Для остальных типов: преобразуются в строку и сравниваются. |
| ==       | 1 == 2               | false                 | Прямое сравнение: Число, Строка, Дата, Булевый тип. Для остальных типов: преобразуются в строку и сравниваются. |
| !=       | 1 != 2               | true                  | Прямое сравнение: Число, Строка, Дата, Булевый тип. Для остальных типов: преобразуются в строку и сравниваются. |
| !        | !(1 > 2)             | true                  | Применяется к булевому значению (результату выражения).                                                         |
| &&       | (1 > 2) && (3 > 2)   | false                 | Работает с булевыми значениями (результатами условий).                                                          |
| **\|\|** | (1 > 2) \|\| (3 > 2) | true                  | Работает с\*\*:\*\* Булевыми значениями (результатами условий).                                                 |
...
| Название поля        | Тип поля | Формула                                      |
|----------------------|----------|----------------------------------------------|
| Количество           | Число    | --                                           |
| Цена за единицу      | Число    | --                                           |
| Скидка %             | Число    | --                                           |
| НДС                  | Число    | --                                           |
| Стоимость без скидки | Число    | \{Количество} \* \{Цена за единицу}          |
| Сумма скидки         | Число    | \{Стоимость без скидки} \* \{Скидка %} / 100 |
| Стоимость со скидкой | Число    | \{Стоимость без скидки} - \{Сумма скидки}    |
| Сумма НДС            | Число    | \{Стоимость со скидкой} \* \{НДС} / 100      |
| Итоговая сумма       | Число    | \{Стоимость со скидкой} + \{Сумма НДС}       |
...
![](<./Пример использования формул.png> "Пример использования формул")