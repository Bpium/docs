...
searchPhrases:
  ...
  - маркер скрыто
  - обязательные поля и права
  - конкуренция правил
  - приоритет иерархии
  - перекрытие правил
---

Помимо прав на записи, в Бипиуме можно ограничивать доступ к отдельным полям анкеты. Одни сотрудники смогут поле редактировать, другие -- только видеть, третьи -- не увидят вовсе.
...
*Пример: Сотрудник может изменить данные Клиентов, но не может изменить ответственного Менеджера. Или сотрудник не может изменить первичную информацию Клиентов, но может изменять статус работы и дату следующего контакта.*
