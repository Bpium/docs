...
searchPhrases:
  ...
  - разрешающие правила
  - запрещающие правила
  - наследуемые правила раздела
  - перекрытие наследования
  - доступ разрешен
  - доступ запрещен
  - примеры настройки прав
  - полный доступ
  - изменять без создания
  - видеть только свои
  - видеть все изменять свои
  - скрытие каталога в меню
  - алгоритм построения
  - индивидуальные права на запись
---
...
Право редактировать поле старше запрета редактировать поле. Действует приоритет иерархии -- если на каталоге запрещено редактировать поле, а на виде разрешено, сотрудник сможет менять поле в записях этого вида. Подробнее в статье [Права на поля](./fields).
