...
Правила могут быть назначены на раздел, каталог, вид или отдельные записи. Правила _для одного и того же субъекта_ (сотрудник или правовая группа) объединяются по приоритету вложенности. То есть правило на запись перезатирает правила на виды. Правила на виды перезатирают правило на каталог. Правило на каталог затирают правило на раздел.
...
**Вывод:** _если для сотрудника на раздел назначена привилегия «Изменять все записи», а на каталог — «Видеть все записи», то сотрудник сможет только видеть записи._&#x20;
