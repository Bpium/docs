...
|---------------------------------|--------------------------------------------------------------------------------------------------------|
| [Права на поля](./fields)       | Ограничение видимости и редактирования отдельных полей внутри записи.                                  |
| [Правила и привилегии](./rules) | Наборы разрешений: что сотрудник может делать с записями -- видеть, создавать, изменять, удалять.      |
| [Правовые группы](./groups)     | Объединение сотрудников в группы для назначения прав сразу всем участникам.                            |
| [Правовые виды](./views)        | Фильтрация записей по условию -- сотрудник видит только те записи, которые соответствуют условию вида. |
| [Комбинация прав](./policy)     | Как правила, группы и виды объединяются в единую правовую политику.                                    |
| [Примеры кейсов](./rights)      | Готовые сценарии настройки прав для типичных задач.                                                    |