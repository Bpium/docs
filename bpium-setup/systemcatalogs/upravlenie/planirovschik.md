...
Администратор создаёт задачу и задаёт расписание -- когда и как часто запускать. В нужный момент система автоматически запускает указанные сценарии. Результат каждого запуска фиксируется в каталоге [Процессы](./processes).
