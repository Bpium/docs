...
Условие — ветвление внутри сценарии. Настраивается с помощью компонента «[Шлюз ИЛИ](../../components/sistemnye/shlyuz-ili-uslovnoe-vetvlenie.md)» задания условий на выходящие соединительные линии.
