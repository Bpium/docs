...
* В отделе «Управление» в каталоге «[События](../../systemcatalogs/upravlenie/events.md)» добавьте новую запись (событие, по которому будет запускаться процесс).
...
* Выберите тип события для запуска сценария. Подробнее в статье «[События](../../systemcatalogs/upravlenie/events.md)».
* В поле «Выполнить» выберите или создайте новый сценарий.

<figure><img src="../../../.gitbook/assets/Запись в каталоге События.png" alt=""><figcaption><p>Запись в каталоге События</p></figcaption></figure>
...
* На это событие, нужно создать [вебкух](../../systemcatalogs/upravlenie/webhooks.md) «во время редактирования».
