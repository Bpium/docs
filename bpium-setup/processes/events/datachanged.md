...
* В отделе «Управление» в каталоге «[События](../../systemcatalogs/yadro/events.md)» добавьте новую запись (событие, по которому будет запускаться процесс).
...
* Выберите тип события для запуска сценария. Подробнее в статье «[События](../../systemcatalogs/yadro/events.md)».
...
* На это событие, нужно создать [вебкух](../../systemcatalogs/yadro/webhooks.md) «во время редактирования».
