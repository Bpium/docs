...
На странице «[Процессы](../../systemcatalogs/yadro/processes.md)» подробно описан общий принцип работы системы процессов в Бипиуме.
...
* [Создать правило для запуска по таймеру](../../../cases/automations/upravlenie-zadachami-i-taim-menedzhment/planirovshik-zadach.md)
...
Успешно или ошибочно исполненный процесс сохраняется в каталоге «[Процессы](../../systemcatalogs/yadro/processes.md)» с указанием статуса исполнения и результата.
