---
description: >-
  События — это точки запуска процессов. Они определяют, когда и при каких
  условиях должен стартовать сценарий.
---
...
На странице «[Процессы](../../systemcatalogs/upravlenie/processes.md)» подробно описан общий принцип работы системы процессов в Бипиуме.
...
Успешно или ошибочно исполненный процесс сохраняется в каталоге «[Процессы](../../systemcatalogs/upravlenie/processes.md)» с указанием статуса исполнения и результата.
