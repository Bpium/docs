...
На странице «[Процессы](../../systemcatalogs/upravlenie/scripts/processes.md)» подробно описан общий принцип работы системы процессов в Бипиуме.
...
Успешно или ошибочно исполненный процесс сохраняется в каталоге «[Процессы](../../systemcatalogs/upravlenie/scripts/processes.md)» с указанием статуса исполнения и результата.
