...
searchPhrases:
  ...
  - статус ошибка
  - ошибка
  - компонент конец процесса
  - ошибочный конец
  - накопленные переменные
---

## Запуск процесса

На странице «[Процессы](./../../systemcatalogs/upravlenie/processes)» подробно описан общий принцип работы системы процессов в Бипиуме.

Запустить процесс можно подписавшись на одно из событий:

-  [Создав подписку на событие об изменении данных в Бипиуме](./datachanged)

-  [Создать адрес для приема внешних веб-запросов](./webrequests)
...
Успешно или ошибочно исполненный процесс сохраняется в каталоге «[Процессы](./../../systemcatalogs/upravlenie/processes)» с указанием статуса исполнения и результата.
