...
* [Начало процесса](broken-reference)
* [Конец процесса](broken-reference)
* [Таймер](broken-reference)
...
* [Ошибка](broken-reference) — выход из компонента, если произошла какая-либо ошибка
...
* [Шлюз «ИЛИ» (условное ветвление)](broken-reference)
* [Шлюз «И» (распараллеливание)](broken-reference)
...
* [Соединяющая линия](kommunikacii/line.md)
