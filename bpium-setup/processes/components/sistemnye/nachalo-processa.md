...
<figure><img src="../../../../.gitbook/assets/Компонент Начало процесса.png" alt=""><figcaption><p>Компонент Начало процесса</p></figcaption></figure>
...
Подробнее в статье: [Переменные](../../scripts/variables.md).
