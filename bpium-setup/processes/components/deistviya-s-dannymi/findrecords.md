...
Формат указания [расширенных полей](/broken/pages/-LACZqPaRG9Botf4XgxZ#svyazannyi-katalog):
...
* `IDкаталогаХ` — Идентификатор каталога связанного каталога. Поле «[связанные каталог](/broken/pages/-LACZqPaRG9Botf4XgxZ#svyazannyi-katalog)» может иметь несколько источников. Для каждого каталога источника можно указать какие именно поля нужно получить.
