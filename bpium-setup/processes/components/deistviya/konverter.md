...
<div align="left"><figure><img src="../../../../.gitbook/assets/bpium-webinar-Сценарии-12-11-2025_11_23_AM.png" alt=""><figcaption></figcaption></figure></div>
...
* `DOCX` → `PDF`: Генерация PDF буфера, принимает в качестве входных переменных DOCX файл из записи или ссылку на файл. Вывод компонента может содержать как сам PDF-файл, так и его буфер.
