...
После необходимо создать [внешний запрос ](../systemcatalogs/yadro/weblisteners.md)задав ему URL-идентификатор и прикрепив созданный нами сценарий.\
...
{% hint style="info" %}
Подробнее о настройке правовой политики в статье «[Права](broken-reference)».
{% endhint %}
