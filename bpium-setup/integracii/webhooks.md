...
Процесс создания вебхуков в Бипиуме описан в статье «[Вебхуки](../systemcatalogs/webhooks.md)».\
...
Список вебхуков хранится в каталоге «[Вебхуки](../systemcatalogs/webhooks.md)» в отделе «Управление». Это значит, что для получения вебхуков и создания новых можно использовать стандартные методы [API Бипиума](api/).
