...
```
{domain}/api/v1/catalogs/27/records/1/relations?catalogId=29&catalogId=28&fieldId=6
```
...
```
{domain}/api/v1/catalogs/{catalogId}/records/{recordId}/relations?catalogId={catalogId}&sortField=7&sortType=-1
```
