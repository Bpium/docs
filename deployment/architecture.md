---
description: >-
  На странице представлено описание топологии системы в инфраструктуре:
  компонентов, сервисов и их взаимодействия, включая масштабирование и
  отказоустойчивость.
icon: reel
...
На странице представлено описание топологии системы в инфраструктуре: компонентов, сервисов и их взаимодействия, включая масштабирование и отказоустойчивость.
...
Поддерживаются разные способы разворачивания системы: из файлов, через Docker-образы, в среде Kubernetes, PM2 и других.

## Стек технологий

Бипиум построен на базе современного, кроссплатформенного стека технологий:

**Бэкенд:** Node.js (на нем написан API-сервер, обеспечивающий работу платформы).

**Фронтенд (Интерфейс):** React.js для веб-версии.
