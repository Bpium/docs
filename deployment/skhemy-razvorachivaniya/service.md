...
* если вы используете [вебхуки](../../bpium-setup/systemcatalogs/yadro/webhooks.md), то на их адреса и порты
{% endtab %}
...
* `Bpium BPM → внешний мир` \
  если в сценарии вы используете компоненты [Веб-запрос](../../bpium-setup/processes/components/deistviya/webrequest.md), то на адреса и порты, используемые в запросах\

* `Bpium BPM → внешний мир` \
  если в сценарии вы используете компоненты [SQL-запрос](../../bpium-setup/processes/components/deistviya/sql.md), то на адреса и порты, используемые в запросах\
