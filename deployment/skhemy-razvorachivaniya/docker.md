...
[Bpium](./../nastroika-i-zapusk/parametry-config.env/bpium)\
[BPM](./../nastroika-i-zapusk/parametry-config.env/bpium-bpm)\
[S3](./../nastroika-i-zapusk/parametry-config.env/bpium-s3)
...
![Обратите внимание на статус контейнера. Up - свидетельствует о корректной работе.](<./image (55) (1).png>)

Теперь ваш Бипиум должен быть доступен по доменному имени/адресу хоста.\
Сам вход в приложение описан [здесь](./../nastroika-i-zapusk/zapusk).
