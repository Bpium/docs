---
title: Брендирование (Whitelabel)
order: 1.8
---
...
### Загрузка логотипа и фавиконки

Загрузить логотип и фавиконку компании можно в каталоге «Компании» раздела «Система»:

![](./whitelabel.png){width=1915px height=952px}