...
*Сервер баз данных может быть совмещен с сервером приложения.*
...
*Сервер файлового хранилища может быть совмещен с сервером приложения.*
...
*Сервер бизнес процессов может быть совмещен с сервером приложения.*
...
*Сервер очереди может быть совмещен с сервером бизнес процессов*
