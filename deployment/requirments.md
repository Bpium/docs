---
description: >-
  Данная страница предназначена для описания системных требований к платформе
  Бипиум, а также предоставляет рекомендации по настройке серверной
  инфраструктуры и выделению ресурсов.
icon: microchip
---
