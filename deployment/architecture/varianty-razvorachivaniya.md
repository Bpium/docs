...
## **Общая структура** <a href="#_19ev1v8ycb0r" id="_19ev1v8ycb0r"></a>
...
## Основные схемы <a href="#_1kw585ricuu0" id="_1kw585ricuu0"></a>

### **Минимальный набор для тестового запуска Бипиум** <a href="#_zeyl26ndwj6c" id="_zeyl26ndwj6c"></a>

#### **Описание:** <a href="#_w3eotrjqm8k1" id="_w3eotrjqm8k1"></a>
...
#### **Требуемое ПО:** <a href="#_ggtv9pqb3ggx" id="_ggtv9pqb3ggx"></a>

* Дистрибутив Bpium
* PostgreSQL
* Redis

#### **Как настроить:** <a href="#_4dgj8yy540gq" id="_4dgj8yy540gq"></a>

1. Установить PostgreSQL и создать пустую базу данных\
   • Версия не ранее 10 (допустимы 11+, 12+, 13+, 14+, 15+)\
...
3. Собрать конфигурационный файл config.env для Bpium.\
   Ознакомиться со всеми параметрами можно в статье [Параметры config.env ](../extra/parametry-config.env/)Необходимые минимальные для данной схемы параметры и их описание:
...
### **Рекомендуемый набор для рабочего (production) запуска Бипиум** <a href="#_k46db5ukmtcc" id="_k46db5ukmtcc"></a>

#### **Описание:** <a href="#_8jvt3qssgmrv" id="_8jvt3qssgmrv"></a>
...
#### **Требуемое ПО:** <a href="#_l3hxxd7sf3u" id="_l3hxxd7sf3u"></a>
...
#### **Как настроить:** <a href="#_5jxcrzhpi25q" id="_5jxcrzhpi25q"></a>
