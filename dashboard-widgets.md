...
Графики при расчёте данных учитывают [фильтры](filters.md) каталога и видов. Это значит, что изменяя фильтры или выбирая вид, все графики перестраиваются и рассчитывают показатели исходя из записей, попавших под условия поиска.
