...
<summary><a href="sections.md">Разделы (Sections)</a> — список разделов (групп каталогов)</summary>
...
<summary><a href="soobsheniya-messages.md">Сообщения (Messages)</a> — ресурс платформы, манипулирующий с сообщениями в каждой записи в Бипиуме.</summary>
