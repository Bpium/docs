...
* Лайв-события (Changes) — запрос на вызов события «[изменено поле время редактирования](../../bpium-setup/processes/events/datachanged.md#izmeneno-pole-vo-vremya-redaktirovaniya-updating)» для запуска сценария обработки значения полей, которые вводит сотрудник в анкете записи
