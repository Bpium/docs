...
Подробнее в статье «[API](./../api/_index)».
...
Подробнее в разделе «Бизнес-процессы» в статье «[Внешние запросы](./../../bpium-setup/processes/events/webrequests)».
...
**Формат обмена:** в формате Бипиума.\
Подробнее в статье «[Вебхуки](./../webhooks)».
...
Подробнее в статье «[Бизнес-процессы](./../../bpium-setup/processes/_index)» и в описании компоненте «[Веб-запрос](./../../bpium-setup/processes/components/deistviya/webrequest)».
...
Подробнее в статье «[Бизнес-процессы](./../../bpium-setup/processes/_index)» и в описании компоненте «[SQL-запрос](./../../bpium-setup/processes/components/deistviya/sql)».