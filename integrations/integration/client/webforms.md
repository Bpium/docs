...
После необходимо создать [внешний запрос ](../../../manual/structure/systemcatalogs/weblisteners.md)задав ему URL-идентификатор и прикрепив созданный нами сценарий.\
