...
![Отображение Бипиума в Tilda](<../../../.gitbook/assets/1 (4).png>)
...
![Табличное отображение каталога в Tilda](<../../../.gitbook/assets/2 (4).png>)

Помимо стандартного табличного вида, каталог можно отображать в плиточном и календарном видах:

![Плиточное отображение каталога в Tilda](<../../../.gitbook/assets/3 (4).png>)

![Календарное отображение каталога в Tilda](<../../../.gitbook/assets/4 (3).png>)
