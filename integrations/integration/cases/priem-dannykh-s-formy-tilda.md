...
_Эл. почта **- email**_\
_Телефон_ - _**phone**_\
_Чем мы можем помочь?_ - _**comment**_
...
В Бипиум есть возможность создания специальных ссылок для приема данных из сторонних сервисов. Этот инструмент называется [_**Внешние запросы**_](../../../ecm/catalogs/webrequests.md). Создать внешний запрос для приема данных можно в каталоге _**Внешние запросы**_. По умолчанию этот каталог находится в отделе _**Управление.**_ Переходим в этот каталог и нажимаем кнопку _**Добавить:**_

<figure><img src="../../../.gitbook/assets/image (4).png" alt="" width="563"><figcaption></figcaption></figure>

Заполните поля как на скриншоте выше. \
Также у _**Внешнего запроса**_ должен быть [сценарий](../../../processes/scripts.md), который обрабатывает полученные данные. Сценарий указывается в поле _**Выполнить.**_ Добавим новый сценарий. Для этого нажмите кнопку _**Добавить в «Сценарии»:**_
...
**\[Домен]** - это Ваш домен системы Бипиум. Например: https://tilda-demo.bpium.ru/\
**\[URL-идентификатор]** - это значение, которое мы ввели в записи внешнего запроса в поле _**URL-идентификатор**_\
...
<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-10-21 154339.png" alt="" width="563"><figcaption></figcaption></figure>

 

<figure><img src="../../../.gitbook/assets/Снимок экрана 2024-10-21 154322.png" alt="" width="251"><figcaption></figcaption></figure>

</div>

Укажем адрес, созданный в предыдущем шаге и добавим этот Webhook:

<figure><img src="../../../.gitbook/assets/image (72).png" alt="" width="487"><figcaption></figcaption></figure>

После создания Webhook'а в Tilda, будет отправлен тестовый запрос на указанный адрес. Проверить, что все действия выше проделаны правильно можно в каталоге [_**Процессы**_](../../../ecm/catalogs/processes.md)_**.**_ В данном каталоге должна быть одна запись со статусом _**Завершен**_:
