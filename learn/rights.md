...
Способы решения типовых бизнес задач по работе с информацией. Большинство решений включает настройку [структуру данных](../bpium-setup/structure/#katalogi-i-otdely)  и системы [прав доступа](broken-reference) к данным.
...
**Инструменты:** [права](broken-reference), [правовые группы](../bpium-setup/prava/groups.md)
...
**Инструменты:** [права](broken-reference), [правовые виды](../bpium-setup/prava/views.md)
...
**Инструменты:** [права](broken-reference), [правовые виды](../bpium-setup/prava/views.md), [фильтр «Я / Смотрящий»](https://docs.bpium.ru/manual/structure/catalogs/filter#sotrudniki)
...
**Инструменты:** [права](broken-reference), [права на поля](../bpium-setup/prava/fields.md)
...
**Инструменты:** [права](broken-reference), [правовые виды](../bpium-setup/prava/views.md), [права на поля](../bpium-setup/prava/fields.md)
...
**Инструменты:** [редактирование поля связанный объект](https://docs.bpium.ru/manual/structure/catalogs/edit#svyazannyi-katalog), [права](broken-reference), [правовые виды](../bpium-setup/prava/views.md), [фильтр «Я / Смотрящий»](https://docs.bpium.ru/manual/structure/catalogs/filter#sotrudniki)
