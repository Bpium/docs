...
Способы решения типовых бизнес задач по работе с информацией. Большинство решений включает настройку [структуру данных](../bpium-setup/structure/#katalogi-i-otdely)  и системы [прав доступа](../bpium-setup/rights/) к данным.
...
**Инструменты:** [права](../bpium-setup/rights/), [правовые группы](../bpium-setup/rights/groups.md)
...
**Инструменты:** [права](../bpium-setup/rights/), [правовые виды](../bpium-setup/rights/views.md)
...
**Инструменты:** [права](../bpium-setup/rights/), [правовые виды](../bpium-setup/rights/views.md), [фильтр «Я / Смотрящий»](https://docs.bpium.ru/manual/structure/catalogs/filter#sotrudniki)
...
**Инструменты:** [права](../bpium-setup/rights/), [права на поля](../bpium-setup/rights/fields.md)
...
**Инструменты:** [права](../bpium-setup/rights/), [правовые виды](../bpium-setup/rights/views.md), [права на поля](../bpium-setup/rights/fields.md)
...
**Инструменты:** [редактирование поля связанный объект](https://docs.bpium.ru/manual/structure/catalogs/edit#svyazannyi-katalog), [виды](../bpium-setup/structure/views.md)
...
**Инструменты:** [редактирование поля связанный объект](https://docs.bpium.ru/manual/structure/catalogs/edit#svyazannyi-katalog), [права](../bpium-setup/rights/), [правовые виды](../bpium-setup/rights/views.md), [фильтр «Я / Смотрящий»](https://docs.bpium.ru/manual/structure/catalogs/filter#sotrudniki)
...
**Инструменты:** [события](../bpium-setup/processes/events/#zapusk-processa), [процессы](../bpium-setup/systemcatalogs/yadro/processes.md), [вебхуки](../bpium-setup/integracii/webhooks.md)
