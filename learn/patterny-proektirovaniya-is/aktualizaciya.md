...
Для описанного выше примера нужно настроить дополнительный сценарий, запускающийся по механизму “[**Планировщика задач**](../../cases/automations/instrumenty/planirovshik-zadach.md)”, который будет ежедневно (или с другим интервалом) актуализировать статус просроченности каждого запроса.
