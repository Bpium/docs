...
![Отображение Бипиума в Tilda](<../../../.gitbook/assets/1 (9).png>)
...
![Табличное отображение каталога в Tilda](<../../../.gitbook/assets/2 (10).png>)

Помимо стандартного табличного вида, каталог можно отображать в плиточном и календарном видах:

![Плиточное отображение каталога в Tilda](<../../../.gitbook/assets/3 (10).png>)

![Календарное отображение каталога в Tilda](<../../../.gitbook/assets/4 (18).png>)
