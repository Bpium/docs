# 🔑 Права доступ к данным

Способы решения типовых бизнес задач по работе с информацией. Большинство решений включает настройку [структуру данных](../structure.md#katalogi-i-otdely)  и системы [прав доступа](../policy.md) к данным.
...
**Инструменты:** [права](../policy.md), [правовые группы](../policy-groups.md)
...
**Инструменты:** [права](../policy.md), [правовые виды](../policy-views.md)
...
**Инструменты:** [права](../policy.md), [правовые виды](../policy-views.md), [фильтр «Я / Смотрящий»](https://docs.bpium.ru/manual/structure/catalogs/filter#sotrudniki)
...
**Инструменты:** [права](../policy.md), [права на поля](../policy-fields.md)
...
**Инструменты:** [права](../policy.md), [правовые виды](../policy-views.md), [права на поля](../policy-fields.md)
...
**Инструменты:** [редактирование поля связанный объект](https://docs.bpium.ru/manual/structure/catalogs/edit#svyazannyi-katalog), [виды](../views.md)
...
**Инструменты:** [редактирование поля связанный объект](https://docs.bpium.ru/manual/structure/catalogs/edit#svyazannyi-katalog), [права](../policy.md), [правовые виды](../policy-views.md), [фильтр «Я / Смотрящий»](https://docs.bpium.ru/manual/structure/catalogs/filter#sotrudniki)
...
**Инструменты:** [события](../processes/events.md#zapusk-processa), [процессы](../ecm/catalogs/processes.md), [вебхуки](../webhooks.md)
