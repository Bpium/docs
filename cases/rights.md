...
**Инструменты:** [права](../manual/rights/), [правовые виды](../manual/rights/views.md), [фильтр «Я / Смотрящий»](https://docs.bpium.ru/manual/structure/catalogs/filter#sotrudniki)
...
**Инструменты:** [редактирование поля связанный объект](https://docs.bpium.ru/manual/structure/catalogs/edit#svyazannyi-katalog), [виды](../manual/structure/views.md)
...
**Инструменты:** [редактирование поля связанный объект](https://docs.bpium.ru/manual/structure/catalogs/edit#svyazannyi-katalog), [права](../manual/rights/), [правовые виды](../manual/rights/views.md), [фильтр «Я / Смотрящий»](https://docs.bpium.ru/manual/structure/catalogs/filter#sotrudniki)
...
**Инструменты:** [события](../manual/processes/events/#zapusk-processa), [процессы](../manual/structure/systemcatalogs/processes.md), [вебхуки](../integrations/integration/data/webhooks.md)
