...
## v1.10.7 от 7 декабря 2022

Версия API: 1.10.2\
Версия веб-приложения: 1.13.21\
Версия сервера процессов: 1.9.23
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.10.7/bpium-win-v1.10.7.zip) или [Linux](https://download.bpium.ru/builds/1.10.7/bpium-linux-v1.10.7.zip).

**Докер-образы** bpiumdocker/bpium:v1.10.7, bpiumdocker/bpm:v1.10.7, bpiumdocker/s3:v1.10.7
{% endhint %}
