...
* Запросы с сервера процессов отправлются в повторные попытки при неудачном соединении

{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://storage.yandexcloud.net/download.bpium.ru/builds/1.12.7/bpium-win-v1.12.7.zip) или Linux
