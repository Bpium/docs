...
## v1.10.2 от 31 октября 2022

Версия API: 1.10.1\
Версия веб-приложения: 1.13.17\
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.10.2/bpium-win-v1.10.2.zip) или [Linux](https://download.bpium.ru/builds/1.10.2/bpium-linux-v1.10.2.zip).

**Докер-образы** bpiumdocker/bpium:v1.10.2, bpiumdocker/bpm:v1.10.2, bpiumdocker/s3:v1.10.2
{% endhint %}
