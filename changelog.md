...
## v2.1.9 от 25 сентября 2025

Версия API: 2.1.9\
Версия веб-приложения: 2.0.15\
Версия сервера процессов: 2.1.9\
...
* Исправлена ошибка передачи параметров (например, $body) в событие запроса.
...
*   Исправлена ошибка отображения времени создания в истории записи.\
    ...
    {% hint style="info" %}
    **Скачать дистрибутив** архивом для [Windows](https://storage.yandexcloud.net/download.bpium.ru/builds/2.1.9/bpium-win-v2.1.9.zip) или [Linux](https://storage.yandexcloud.net/download.bpium.ru/builds/2.1.9/bpium-linux-v2.1.9.zip)
