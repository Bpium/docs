...
* Добавлена возможность создания, редактирования и удаления графических [Отчётов](rabota-v-bipiume/list/reports.md)
* Добавлена возможность расширения [графика](broken-reference) в отчётах на весь экран&#x20;
...
* Исправлена загрузка [активностей](rabota-v-bipiume/records/activity.md) по прокрутки страницы
