...
* Добавлены вкладки в анкете в виде нового типа отображения для вкладок “табы”
...
* Добавлен способ взаимодействия с ячейками записей по двойному нажатию
* Уменьшен общий размер приложения в два раза
* Оптимизированы методы открытия записей, а так же чатов
* Куча мелких интерфейсных изменений
...
* Ранее сортировка записей могла работать некорректно
...
* Новый для использования в сценариях модуль “crypto”
