...
## v3.0.0 от 16 декабря 2025

Версия API: 3.0.0\
Версия веб-приложения: 3.0.0\
Версия сервера процессов: 3.0.0<br>
...
* Добавлен компонент сценариев автоматической отправки сообщений в WhatsApp и Telegram с возможностью отправки от имени пользователя вместо бота.
...
* Добавлена авторизация через внутрекорпоративные сервисы на базе OAuth2.0, OpenID, KeyCloak, SSO
...
* Добавлена возможность изменять скорость воспроизведения загруженных аудиофайлов внутри карточек.
