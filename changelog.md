...
## v1.10.6 от 2 декабря 2022

Версия API: 1.10.2\
Версия веб-приложения: 1.13.21\
Версия сервера процессов: 1.9.21
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.10.6/bpium-win-v1.10.6.zip) или [Linux](https://download.bpium.ru/builds/1.10.6/bpium-linux-v1.10.6.zip).

**Докер-образы** bpiumdocker/bpium:v1.10.6, bpiumdocker/bpm:v1.10.6, bpiumdocker/s3:v1.10.6
{% endhint %}
