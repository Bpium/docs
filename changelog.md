...
## v1.11.7 от 20 сентября 2023

Версия API: 1.11.7\
Версия веб-приложения: 1.14.4\
Версия сервера процессов: 1.10.0\
\
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows ](https://download.bpium.ru/builds/1.11.7/bpium-win-v1.11.7.zip)или [Linux](https://download.bpium.ru/builds/1.11.7/bpium-linux-v1.11.7.zip)

**Докер-образы** bpiumdocker/bpium:v1.11.7, bpiumdocker/bpm:v1.11.7, bpiumdocker/s3:v1.11.7
{% endhint %}
