...
## v1.11.6 от 31 августа 2023

Версия API: 1.11.4\
Версия веб-приложения: 1.14.3\
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.11.6/bpium-win-v1.11.6.zip) или [Linux](https://download.bpium.ru/builds/1.11.6/bpium-linux-v1.11.6.zip)

**Докер-образы** bpiumdocker/bpium:v1.11.6, bpiumdocker/bpm:v1.11.6, bpiumdocker/s3:v1.11.6
{% endhint %}
