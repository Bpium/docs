...
## v1.13.7 от 18 июля 2024

Версия API: 1.13.7\
Версия веб-приложения: 1.16.1\
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://storage.yandexcloud.net/download.bpium.ru/builds/1.13.7/bpium-win-v1.13.7.zip) или [Linux](https://storage.yandexcloud.net/download.bpium.ru/builds/1.13.7/bpium-linux-v1.13.7.zip)

**Докер-образы** bpiumdocker/bpium:v1.13.7, bpiumdocker/bpm:v1.13.7, bpiumdocker/s3:v1.13.7
{% endhint %}
