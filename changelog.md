...
## v1.9.0 от 13 мая 2022

Версия API: 1.9.11\
Версия веб-приложения: 1.12.1\
Версия сервера процессов: 1.9.8
...
* Убран компонент «Сгенерировать документ» для генерации файлов Word и Excel по шаблонам, функционал перемещен в компонент «Конвертировать файл»
* Добавлен метод генерации документа по шаблону Word→PDF в компонент «Конвертировать файл»&#x20;

{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.9.0/bpium-win-v1.9.0.zip) или [Linux](https://download.bpium.ru/builds/1.9.0/bpium-linux-v1.9.0.zip).\
**Докер-образы** bpiumdocker/bpium:1.9.0, bpiumdocker/bpm:1.9.0, bpiumdocker/s3:1.9.0
{% endhint %}
