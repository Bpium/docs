...
* Добавлены API ресурсы [Values](integracii/api/agregate/values.md) и [Totals](integracii/api/agregate/totals.md) для получения разложений и сводных значений по записям каталога без создания графиков (дашбордов)
