...
## v1.10.5 от 15 ноября 2022

Версия API: 1.10.2\
Версия веб-приложения: 1.13.20\
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.10.5/bpium-win-v1.10.5.zip) или [Linux](https://download.bpium.ru/builds/1.10.5/bpium-linux-v1.10.5.zip).

**Докер-образы** bpiumdocker/bpium:v1.10.5, bpiumdocker/bpm:v1.10.5, bpiumdocker/s3:v1.10.5
{% endhint %}
