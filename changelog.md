...
## v1.9.17 от 24 октября 2022

Версия API: 1.10.1\
Версия веб-приложения: 1.13.12\
Версия сервера процессов: 1.9.18
...
* Добавлена функция массового редактирования записей
* Добавлена функция импорта данных из Excel
* Добавлена английская версия интерфейса&#x20;
* Расширен функционал условной видимости полей
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.9.17/bpium-win-v1.9.17.zip) или [Linux](https://download.bpium.ru/builds/1.9.17/bpium-linux-v1.9.17.zip).\
**Докер-образы** bpiumdocker/bpium:v1.9.17, bpiumdocker/bpm:v1.9.17, bpiumdocker/s3:v1.9.17
{% endhint %}
...
* Добавлена возможность задавать в качестве [выходных параметров компонентов](processes/scripts.md#vkhodnye-i-vykhodnye-peremennye) не только имя переменной, но и свойство другой переменной-объекта (например: data.rows\[i].values)
...
* Добавлена возможность создания, редактирования и удаления графических [Отчётов](dashboards.md)
* Добавлена возможность расширения [графика](dashboard-widgets.md) в отчётах на весь экран&#x20;
* Добавлен редактор кода в редакторе сценариев
* Добавлена возможность фильтрации [истории записи](records.md#istoriya-izmenenii) по типам полей
...
* Исправлена загрузка [активностей](activity.md) по прокрутки страницы
