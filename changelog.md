...
## v1.10.4 от 10 ноября 2022

Версия API: 1.10.2\
Версия веб-приложения: 1.13.19\
...
* Исправлена проблема в экспортом с применением фильтров по полю типа «Набор галочек»

{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.10.4/bpium-win-v1.10.4.zip) или [Linux](https://download.bpium.ru/builds/1.10.4/bpium-linux-v1.10.4.zip).

**Докер-образы** bpiumdocker/bpium:v1.10.4, bpiumdocker/bpm:v1.10.4, bpiumdocker/s3:v1.10.4
{% endhint %}
