...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.10.1/bpium-win-v1.10.1.zip) или [Linux](https://download.bpium.ru/builds/1.10.1/bpium-linux-v1.10.1.zip).
{% endhint %}
