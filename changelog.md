...
## v1.13.15 от 18 июля 2024

Версия API: 1.13.15\
Версия веб-приложения: 1.16.6\
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://storage.yandexcloud.net/download.bpium.ru/builds/1.13.15/bpium-win-v1.13.15.zip) или [Linux](https://storage.yandexcloud.net/download.bpium.ru/builds/1.13.15/bpium-linux-v1.13.15.zip)

**Докер-образы** bpiumdocker/bpium:v1.13.15, bpiumdocker/bpm:v1.13.15, bpiumdocker/s3:v1.13.15
{% endhint %}
