...
## v1.10.8 от 16 декабря 2022

Версия API: 1.10.3\
Версия веб-приложения: 1.13.23\
Версия сервера процессов: 1.9.24
...
{% hint style="info" %}
**Скачать дистрибутив** архивом для [Windows](https://download.bpium.ru/builds/1.10.8/bpium-win-v1.10.8.zip) или [Linux](https://download.bpium.ru/builds/1.10.8/bpium-linux-v1.10.8.zip).

**Докер-образы** bpiumdocker/bpium:v1.10.8, bpiumdocker/bpm:v1.10.8, bpiumdocker/s3:v1.10.8
{% endhint %}
