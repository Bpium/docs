...
* Добавлена возможность создания, редактирования и удаления графических [Отчётов](rabota-v-bipiume/reports/)
* Добавлена возможность расширения [графика](rabota-v-bipiume/reports/widgets.md) в отчётах на весь экран&#x20;
* Добавлен редактор кода в редакторе сценариев
* Добавлена возможность фильтрации [истории записи](rabota-v-bipiume/records.md#istoriya-izmenenii) по типам полей
...
* Исправлена загрузка [активностей](rabota-v-bipiume/catalogs-setup/activity.md) по прокрутки страницы
