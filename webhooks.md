...
* `values` — измененные значения полей в формате метода API на [получение записи](api-records.md)
...
* `values` — измененные значения полей в формате метода API на [получение записи](api-records.md)
* `prevValues` — предыдущие значения всех полей в формате метода API на [получение записи](api-records.md)
...
* `values` — измененные значения полей в формате метода API на [получение записи](api-records.md)
* `allValues` — все значения полей в формате метода API на [получение записи](api-records.md)
...
**Примечание**: Значения полей `user`, `object` и `file` должны быть переданы со всеми дополнительными параметрами. У каждого из этих полей имеется свой формат, как при [получении записи](api-records.md).
