...
Виды представляют собой сохраненные шаблоны фильтров для быстрого доступа к нужной информации.
...
-  [Правовые](./../../bpium-setup/prava/views) (предоставляют доступ к записям)
...
2. Нажмите на иконку шестерёнки рядом с названием нового вида, далее нажмите на «Сохранить как новый вид».
   ...
   ![](<../../.gitbook/assets/Кнопка сохранить как новый вид.png> "Кнопка сохранения нового вида.")
