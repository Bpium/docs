...
<figure><img src="../../../.gitbook/assets/image (3) (1) (1) (1) (1) (1) (1) (1).png" alt=""><figcaption><p>Операции в каталоге. Изменение записей. Импорт записей. Экспорт записей. Удаление записей.</p></figcaption></figure>

<details>

<summary><a href="avtoobnovlenie.md"><strong>Автообновление</strong></a><strong>.</strong> Операция, при активации которой записи будут обновляться автоматически по мере поступления изменений.</summary>
