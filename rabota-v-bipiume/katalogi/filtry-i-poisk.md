...
\[Скриншот: фильтр по текстовому полю]
...
\[Скриншот: фильтр по числовому полю — поля «от» и «до»]
...
\[Скриншот: фильтр по дате — период дат  ]
...
\[Скриншот: фильтр по дате — период относительно сегодня]

**Предустановленные периоды** — готовые варианты для быстрого выбора.

\[Скриншот: фильтр по дате — раскрытый список предустановленных периодов]
