---
description: >-
  Режим отображения в виде Kanban-доски. Записи раскладываются по столбцам и
  строкам в зависимости от значений выбранных полей. Удобен для управления
  задачами и отслеживания этапов процесса.
---
