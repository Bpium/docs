...
\[Скриншот: пример подсчёта — столбчатый график с разбивкой по турам и менеджерам по горизонтальной оси]
